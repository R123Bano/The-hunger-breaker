                        ...
                        <tbody>
                            {
                                data.map((food, index) => (
                                    <tr>
                                        ...
                                        <td className='text-white'><button type='button' className='btn p-0' onClick={() => { dispatch({ type: "REMOVE", index: index }) }}><img src={trash} alt="delete" style={{ height: "20px" }} /></button></td>
                                    </tr>
                                ))
                            }
                        </tbody>
