...
export default function Signup() {
  ...
  <div className="mb-3">
    <label htmlFor="exampleInputAddress" className="htmlForm-label">Address</label>
    <input type="text" className="htmlForm-control" name='geolocation' value={credentials.geolocation} onChange={onChange} id="exampleInputAddress"/>
  </div>
